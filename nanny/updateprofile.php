...
<body>
	...
	<div class="container content">
		...
		<div class="action" ,style=form{ display:inline-block; }>
			...
			<form method="post" action="updateprofile.php">
				...
				<input type="number" style="width: 93%;padding: 12px;" name="userNo" value="<?php if (!empty($_SESSION['user_nanny'])) {
																								echo $_SESSION['user_nanny']['UserID'];
																							} ?>" selected disabled placeholder="User ID">
				<input type="text" name="name" placeholder="Full Name" value="<?php if (!empty($_SESSION['user_nanny'])) {
																					echo $_SESSION['user_nanny']['username'];
																				} ?>" selected disabled>
